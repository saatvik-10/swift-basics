 ...
 */
var runningChallenges: [String] = ["Run 10 miles on sunday morning", "While coming back from office to home, run instead of taking a cab", "Jog eveeryday for atleast 30 minutes"]
var walkingChallenges: [String] = ["Use stairs instead of lift for atleast 3 floors from now", "Brisk walk for distances atleast 2 kilometers"]
...
var committedChallanges: [String] = []
