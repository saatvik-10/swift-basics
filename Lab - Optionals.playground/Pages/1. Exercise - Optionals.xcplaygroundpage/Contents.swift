...
// Error: Value of optional type 'Int?' must be unwrapped to value of type 'Int'
...
print(userAge)
// As the userInputAge constant wasn't able to get typecasted to Int, the userAge constant of type Int? (optional) got 'nil' assigned to it
/*:
 ...
 */
// The printed value has 'Optional' keyword surrounding it
print(userAge!)
