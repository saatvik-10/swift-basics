...
let ans: String = "As we have defined friends using let, its a constant inside swift and thus we were unable to change the value for friends in the above code. To change the value, we should have used var instead of let"
print(ans)
/*:
